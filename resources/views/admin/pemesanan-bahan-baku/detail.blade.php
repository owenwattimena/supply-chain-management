    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <div class="pull-right" style="margin-bottom: 15px;">
                ...
                @if ($pesanan->status == 'draft' && auth()->user()->role != 'supplier')
                ...
                @endif
                @if ($pesanan->status == 'proses' && auth()->user()->role != 'supplier')
            ...
            <div class="modal fade" id="modal-default">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ route('order-raw-material.order.material', $pesanan->id) }}" method="POST">
                            @csrf
