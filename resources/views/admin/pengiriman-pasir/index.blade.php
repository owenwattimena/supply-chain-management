                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control" id="id_bahan_baku" name="id_bahan_baku">
                                            ...
                                            <option data-stok="{{ $item->stokSupplier->stok }}" value="{{ $item->id }}">{{ $item->nama_bahan_baku }}</option>
                                            @endforeach
                                        </select>
                                        @error('id_bahan_baku')
                                        <span class="help-block">{{ $message }}</span>
                ...
                <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>#</th>
                                @if(auth()->user()->role == 'stockpile' || auth()->user()->role == 'admin')
                                <th></th>
                                @endif
                                <th>Pengiriman</th>
                                <th>Penerimaan</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($pengiriman->where('status', 'diterima')->sortDesc() as $key => $item)
                            <tr>
                                <td>{{ ++$no }}</td>
                                @if(auth()->user()->role == 'stockpile' || auth()->user()->role == 'admin')
                                <td> <a href="{{ route('sand-delivery.show', $item->id) }}" class="btn btn-success btn-flat btn-xs">Detail</a> </td>
